...
async function createNotification(params: {
  ...
  if (error) {
    logger.error('[notifications] Failed to create notification', { error: error.message });
  }
}

export async function sendInterviewScheduledNotification(params: {
  organizationId: string;
...
export async function sendInterviewRescheduledNotification(params: {
  organizationId: string;
  candidateEmail: string;
  candidateName: string;
  interviewerId: string;
...
export async function sendInterviewCancelledNotification(params: {
  organizationId: string;
  candidateEmail: string;
  candidateName: string;
  interviewerId: string;
